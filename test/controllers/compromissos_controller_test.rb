...
class CompromissosControllerTest < ActionController::TestCase
  ...
  test "should create compromisso" do
    assert_difference('Compromisso.count') do
      post :create, compromisso: { date: @compromisso.date, descricao: @compromisso.descricao, titulo: @compromisso.titulo }
    end
  ...
  test "should update compromisso" do
    patch :update, id: @compromisso, compromisso: { date: @compromisso.date, descricao: @compromisso.descricao, titulo: @compromisso.titulo }
    assert_redirected_to compromisso_path(assigns(:compromisso))
  end
